<?php /*a:2:{s:59:"/www/wwwroot/11.fanlipt.com/app/admin/view/order/index.html";i:1647151825;s:64:"/www/wwwroot/11.fanlipt.com/app/admin/view/common/container.html";i:1643093912;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
	...
	<el-table-column :fixed="ismobile()?false:'right'" label="操作" align="center" width="180">
		<template slot-scope="scope">
			<div v-if="scope.row.id">
				<el-button v-if="checkPermission('/admin/Order/update.html','<?php echo implode(",",session("admin.access")); ?>','<?php echo session("admin.role_id"); ?>',[1])" size="mini" icon="el-icon-edit" type="primary" @click="update(scope.row)" >修改</el-button>
...
<script src="/components/admin/order/add.js?v=<?php echo rand(1000,9999)?>"></script>
<script src="/components/admin/order/update.js?v=<?php echo rand(1000,9999)?>"></script>
<script src="/components/admin/order/detail.js?v=<?php echo rand(1000,9999)?>"></script>
<script src="/components/admin/order/pladd.js?v=<?php echo rand(1000,9999)?>"></script>
<script>
new Vue({
	el: '#app',
	components:{
